...
if (strcmp(get(handles.Change1,'String'),'Température prescrite') == 1)
    data.state_1 = 1;
else
    data.state_1 = 2;
end
if (strcmp(get(handles.Change2,'String'),'Température prescrite') == 1)
    data.state_2 = 1;
else
    data.state_2 = 2;
end
if (strcmp(get(handles.Change3,'String'),'Température prescrite') == 1)
    data.state_3 = 1;
else
    data.state_3 = 2;
end
if (strcmp(get(handles.Change4,'String'),'Température prescrite') == 1)
    data.state_4 = 1;
else
    data.state_4 = 2;
end
...
textLabel = sprintf('Résultat du bilan énergétique: %d J\nNombre d''itérations: %d \nTolerance: 10e-7 et dimensions %.2d x %.2d [m]',out1,out2,data.length,data.width);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if (strcmp(get(handles.Change1,'String'),'Ouvert à l''environnement') == 1)
    ...
    set(handles.Change1,'String','Température prescrite');
else
    ...
    set(handles.Change1,'String','Ouvert à l''environnement');
end
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if (strcmp(get(handles.Change2,'String'),'Ouvert à l''environnement') == 1)
    ...
    set(handles.Change2,'String','Température prescrite');
else
    ...
    set(handles.Change2,'String','Ouvert à l''environnement');
end
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if (strcmp(get(handles.Change3,'String'),'Ouvert à l''environnement') == 1)
    ...
    set(handles.Change3,'String','Température prescrite');
else
    ...
    set(handles.Change3,'String','Ouvert à l''environnement');
end
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if (strcmp(get(handles.Change4,'String'),'Ouvert à l''environnement') == 1)
    ...
    set(handles.Change4,'String','Température prescrite');
else
    ...
    set(handles.Change4,'String','Ouvert à l''environnement');
end
